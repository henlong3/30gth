...
const gattahuLevelMap = {
    ...
    12: { // 6 * 2
        1: { bet1: 2 * 2, bet2: 4 * 2, win: { type: 'calcLevelSumCurrentLevel', units: [2 * 2, 4 * 2] }, lose: { type: 'goto', stage: 2 } },
        2: { bet: 8, win: { type: 'goto', level: 16 }, lose: { type: 'gameOver' } }
    },
    14: { // 7 * 2
        1: { bet1: 2 * 2, bet2: 4 * 2, win: { type: 'calcLevelSumCurrentLevel', units: [2 * 2, 4 * 2] }, lose: { type: 'goto', stage: 2 } },
        2: { bet: 10, win: { type: 'goto', level: 20 }, lose: { type: 'gameOver' } }
    },
    16: { // 8 * 2
        1: { bet1: 2 * 2, bet2: 4 * 2, win: { type: 'calcLevelSumCurrentLevel', units: [2 * 2, 4 * 2] }, lose: { type: 'goto', stage: 2 } },
        2: { bet: 12, win: { type: 'goto', level: 24 }, lose: { type: 'gameOver' } }
    },
    18: { // 9 * 2
        1: { bet1: 2 * 2, bet2: 4 * 2, win: { type: 'calcLevelSumCurrentLevel', units: [2 * 2, 4 * 2] }, lose: { type: 'goto', stage: 2 } },
        2: { bet: 14, win: { type: 'goto', level: 28 }, lose: { type: 'gameOver' } }
    },
    20: { // 10 * 2
